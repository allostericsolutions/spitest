...
# Importamos nuestras utilerías y componentesimport streamlit as st
import json
import time
import os
...
st.markdown(
    ...
    body {
        ...
        background-color: transparent !important; /* Make body background transparent */
    }

    /* Remove padding/margins aggressively */
    .stApp {
        padding: 0 !important;
        margin: 0 !important;
    }
    ...
    div[data-testid="stVerticalBlock"] {
        gap: 0 !important; /* Reduce gap between elements */
    }
    </style>
    """,
